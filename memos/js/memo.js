...
let memoUrl = `${memos}/api/v1/memos?limit=${memo.limit}&filter=creator=='users/${memo.creatorId}'%26%26visibilities==['PUBLIC','PROTECTED']`
let pageToken = null
var page = 1,
    offset = 0,
    nextLength = 0,
...
function getNextList() {
    ...
    // }
    let url = ''
    if (pageToken) url = memoUrl + `&pageToken=${pageToken}`
